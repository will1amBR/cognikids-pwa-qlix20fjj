      ...
      <GameShell title="Matriz Lógica Junior" onBack={() => navigate('/junior')}>
        <div className="max-w-md mx-auto text-center space-y-6 py-8">
          ...
          <Card className="p-6 rounded-3xl border-2 border-amber-200 bg-gradient-to-b from-amber-50 to-white shadow-md">
            ...
            <p className="text-xs text-slate-500 mb-3">Módulo de Lógica & Dedução</p>

            <div className="flex justify-center gap-2 text-3xl mb-4">{'⭐'.repeat(stars)}</div>

            <div className="grid grid-cols-2 gap-3 mb-6">
              <div className="bg-amber-100/60 p-3 rounded-2xl">
                <span className="text-[10px] font-bold text-amber-800 uppercase">Pontos</span>
                <p className="text-xl font-black text-amber-950">{score} pts</p>
              </div>
            ...
            <div className="flex gap-3">
              ...
              <Button
                className="flex-1 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold"
